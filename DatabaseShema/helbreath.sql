...
CREATE DATABASE IF NOT EXISTS `helbreath` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `helbreath`;
...
CREATE TABLE IF NOT EXISTS `account_database` (
  ...
  `BlockDate` datetime NOT NULL DEFAULT '1900-01-01 00:00:00',
...
CREATE TABLE IF NOT EXISTS `char_database` (
  ...
  `LastSaveDate` datetime NOT NULL DEFAULT NOW(),
  `BlockDate` datetime NOT NULL DEFAULT '1900-01-01 00:00:00',
  ...
  `TotalEK` int(11) unsigned NOT NULL DEFAULT '0',
...
-- Dumping structure for table helbreath.macblocked
DROP TABLE IF EXISTS `macblocked`;
...
-- Dumping structure for table helbreath.mail
...
-- Dumping structure for table helbreath.stats
